                ...
                <div x-show="activeSlide === {{ $index }}"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-5 sm:p-10 md:p-16">
                        <div class="max-w-4xl">
                            ...
                            @if($banner->link)
                            <a href="{{ $banner->link_url }}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm md:text-base font-semibold px-4 py-2 md:px-6 md:py-3 rounded-lg transition-colors">
                                Saiba Mais
                            </a>
                            @endif
                        </div>
